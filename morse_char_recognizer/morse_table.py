...
PROSIGNS: dict[str, str] = {
    ...
    # Common run-together amateur abbreviations. These are not always written
    # as formal prosigns, but real operators often send them without the
    # normal inter-character gap, so they are useful glyph classes.
    "<UR>": "..-.-.",    # your / you're
    "<BK>": "-...-.-",   # break
}
