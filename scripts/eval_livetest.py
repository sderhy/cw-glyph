...
def _evaluate_window(
    ...
    if args.bandpass_width_hz is not None:
        local_envelope = replace(local_envelope, bandpass_width_hz=args.bandpass_width_hz)

    segment_config = SegmentConfig(
        bandpass_center_hz=local_envelope.bandpass_center_hz,
        bandpass_width_hz=local_envelope.bandpass_width_hz,
        noise_floor_percentile=local_envelope.noise_floor_percentile,
